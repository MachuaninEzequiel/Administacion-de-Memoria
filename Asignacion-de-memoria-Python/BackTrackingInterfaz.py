        ...
        for i, combination in enumerate(self.combinations):
            ...
            if total_processes > 0:
                ...
                for process in combination:
                    combination_info += f"\nProcess {process.process_id}: Size: {process.size}"
...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.combinations_text = tk.Text(self, height=25, width=70)
    ...
    def display_combinations(self, combinations_info):
        ...
        self.combinations_text.insert("1.0", "\n\n".join(combinations_info))
